...
#./scripts/gitlab/safe_curl.sh $DATA "http://45.32.70.198:1337/push-release/$CI_BUILD_REF_NAME/$CI_BUILD_REF"
#
#echo "Pushing release to Kovan"
#./scripts/gitlab/safe_curl.sh $DATA "http://45.32.70.198:1338/push-release/$CI_BUILD_REF_NAME/$CI_BUILD_REF"
